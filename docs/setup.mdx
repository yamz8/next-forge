...
3. Copy the forwarding URL provided by Ngrok and add it to your Clerk project's webhook settings.

4. Now you can test Clerk webhooks locally without needing to deploy your app to a staging environment.

Learn how to [install Ngrok](https://ngrok.com/docs/getting-started/) for your operating system.
