...
We use Ngrok to expose your local server to the internet for testing webhooks and other integrations. You can install it with:
...
To start Ngrok and forward requests to port 3002, run:

```sh Terminal
ngrok http 3002
```

This will provide a forwarding URL (e.g., `https://<your-ngrok-subdomain>.ngrok.io`) that you can use to test webhooks and other integrations.
